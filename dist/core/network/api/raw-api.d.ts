...
export declare class RawApi extends BaseApi {
    ...
    post: <Method extends "chats/{chat_id}/members" | "messages" | "chats/{chat_id}/actions" | "uploads" | "answers" | "subscriptions">(method: Method, options: {
        ...
        subscriptions: {
            req: import("./modules").CreateSubscriptionDTO;
            res: import("./modules").CreateSubscriptionResponse;
        };
    }[Method]["req"]) => Promise<{
        'chats/{chat_id}/actions': {
            req: import("./modules").SendActionDTO;
