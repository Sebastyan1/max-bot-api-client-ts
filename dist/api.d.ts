...
import type { AnswerOnCallbackExtra, Client, CreateSubscriptionDTO, DeleteMessageExtra, EditMessageExtra, SendMessageExtra, BotCommand, EditMyInfoDTO, FlattenReq, GetUpdatesDTO, UpdateType } from './core/network/api';
...
export declare class Api {
    ...
    setWebhook: (extra: FlattenReq<CreateSubscriptionDTO>) => Promise<import("./core/network/api").CreateSubscriptionResponse>;
